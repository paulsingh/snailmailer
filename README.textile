...
>> apiauth = SnailMailer::APIAuth.new("1b9884c66a")
=> #<SnailMailer::APIAuth:0x1030c8bf0 @options={:api_endpoint=>"localhost:3000"}>

>> base = SnailMailer::Base.new(apiauth)
=> #<SnailMailer::Base:0x1030c3cb8 @client=#<SnailMailer::APIAuth:0x1030c8bf0 @options={:api_endpoint=>"localhost:3000"}>>
